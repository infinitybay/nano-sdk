...
describe("StatsResponse schema", () => {
  ...
  test("parses Nano node V29 RocksDB database stats response", () => {
    ...
    const result = schema.safeParse({
      ...
      is_write_stopped: "0",
      levels: {
        l0_num_files: "18446744073709551596",
        l1_num_files: "18446744073709551596",
        l2_num_files: "18446744073709551596",
        l3_num_files: "18446744073709551596",
        l4_num_files: "18446744073709551596",
        l5_num_files: "18446744073709551596",
        l6_num_files: "18446744073709551596",
      },
      live_sst_files_size: "27",
      mem_table_flush_pending: "0",
      min_log_number_to_keep: "28",
      min_obsolete_sst_number_to_keep: "18446744073709551596",
